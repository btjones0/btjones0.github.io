...
- Felleisen, Matthias, Robert Bruce Findler, Matthew Flatt, and Shriram Krishnamurthi.
  ...
  [Available as an online book](https://htdp.org/), this is an introduction to
  programming using Racket (technically Racket-like languages designed for teaching).
...
<!--
  NOTE: This book is *fine*, but I don't like it as much as the other two.
