...
- CSC 202
  ...
  > What do we actually learn in data structures?

  Great question! Often, there will be more than one way to solve a given problem. But
  not all solutions are necessarily equal. Sometimes one solution might be
  *dramatically* faster than another. One contributing factor for that difference in
  speed is the way that you've chosen to store the data involved in your problem. The
  rough goal of this class is to understand what options are available to you and why
  you might chose one option over another.

  > How do you recommend to study for this course, or for this subject in general?

  I would strongly suggest keeping up with the labs/projects and asking questions as you
  have them. Reviewing the programming assignments is probably the best way to study for
  this class.

  > Are there any websites that we can practice Python that you recommend?

  I don't have anything specific in mind, I would try asking around if anyone else has
  any ideas. Perhaps on EdStem.

  A good way to practice programming language skills in general is just to try writing
  code in that language. If you're looking for a good source of problems to try, I quite
  like [Advent of Code](https://adventofcode.com/) which is like an advent calendar of
  programming challenges. You can go back and do the problems from any of the past ~10
  years. They get harder as you get further into each year.

  > What advice do you have for us when it comes to grasping the topics in Data
  > Structures since many of the CS courses are based on this one, and what are the most
  > important parts should we focus on?

  For grasping the topics, make sure you are paying attention in class and ask me
  questions when you have them. If something isn't making sense, please let me know.

  As for the most important parts, having a good understanding of the pros/cons of each
  data structure that we look at and why you would choose one over another.
